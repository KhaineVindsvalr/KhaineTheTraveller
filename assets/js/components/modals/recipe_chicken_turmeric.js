...
<div id="recipeChickenTurmericModal" aria-hidden="true" style="display: none; position: fixed; inset: 0; z-index: 200; background: rgba(15, 23, 42, 0.95);" onclick="event.target.id === 'recipeChickenTurmericModal' && toggleModal('recipeChickenTurmericModal')">
    ...
    <div style="position: absolute; inset: 0; display: flex; flex-direction: column;" onclick="event.stopPropagation()">
        ...
        <!-- Close Button (Top) -->
        <button onclick="toggleModal('recipeChickenTurmericModal')" 
        ...
        <iframe src="assets/recipe_chicken_turmeric.html" 
                style="width: 100%; height: 100%; border: none; display: block;" 
                title="Ricetta Pollo alla Curcuma">
        </iframe>
...
console.log("Recipe Chicken Turmeric Modal Loaded Successfully.");
