...
window.footerHTML = `
    ...
    <footer class="bg-slate-950 text-slate-500 py-16 px-6">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center italic mb-8">
        ...
        <div class="max-w-4xl mx-auto text-center border-t border-slate-800 pt-8">
            <p class="text-[10px] md:text-xs leading-relaxed opacity-60 max-w-2xl mx-auto italic">
                I contenuti di questo sito hanno scopo informativo e di consulenza creativa. Non si effettuano vendite di pacchetti turistici o servizi di intermediazione.
            </p>
        </div>
    </footer>
`;
